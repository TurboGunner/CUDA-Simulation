...
cudaError_t CopyFunction(const string err_msg, void* tgt, const void* src, const cudaMemcpyKind mem_copy_type, const cudaError_t error, const size_t size_alloc, const size_t element_alloc = 1);
